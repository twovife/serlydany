...
const SaveDate = () => {
    ...
    return (
        <motion.div animate={isInView ? show : hide} ref={ref} className="bg-gray-200 h-dvh relative z-0">
            ...
            <motion.div
                ...
                <motion.div variants={animatedChild} className={`${yesteryear.className} text-5xl mb-3`}>
                    Save The Date
                </motion.div>
